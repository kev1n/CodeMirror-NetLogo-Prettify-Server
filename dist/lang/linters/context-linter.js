...
import { Procedure } from '../classes/structures';
...
export const ContextLinter = (view, preprocessContext, lintContext) => {
    const diagnostics = [];
...
const checkProcedureContents = function (p, lintContext) {
    let diagnostics = [];
