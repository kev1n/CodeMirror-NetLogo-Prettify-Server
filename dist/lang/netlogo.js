...
import { LRLanguage, LanguageSupport, delimitedIndent, indentNodeProp, foldNodeProp, foldInside, ParseContext, } from '@codemirror/language';
...
function delimitedStrategy(context) {
    ...
    let closing = '[\n', align = context.node.firstChild?.name != 'Arg' && context.node.firstChild?.name != 'LineComment', units = 1;
...
export function NetLogo(Editor) {
